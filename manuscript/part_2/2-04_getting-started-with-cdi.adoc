...
What does this specification do? Well, it defines many things, many concepts, and the way those concepts interact between themselves. To understand the overall, you need to know CDI well. Basically, to understand CDI, you need to have a good understanding of CDI, which is a good example of the chicken and egg problem.
