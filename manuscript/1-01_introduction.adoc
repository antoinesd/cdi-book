...
[plantuml, generated_chap01-1, svg , width=750]
----
@startuml
...
[source]
----
include::{sourcedir}/chap01/nocdi/PostService.java[tags=snippets]
----
...
[source]
----
include::{sourcedir}/chap01/cdi/PostService.java[tags=snippets]
----
...
[source]
----
include::{sourcedir}/chap01/cdi/NewPost.java[tags=snippets]
----
...
[source]
----
include::{sourcedir}/chap01/cdi/WebSocketNotifService.java[tags=snippets]
----
