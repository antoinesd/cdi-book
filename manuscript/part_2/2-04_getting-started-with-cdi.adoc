...
Now that we had an introduction to the concept of specification and to the main CDI features, it's time to dive into the core concepts of the specification.
